...
foreach(_cmake_expected_target IN ITEMS openvino::frontend::onnx openvino::frontend::pytorch openvino::frontend::tensorflow openvino::frontend::tensorflow_lite openvino::frontend::paddle openvino::frontend::gguf openvino::runtime openvino::runtime::c)
...
# Create imported target openvino::frontend::gguf
add_library(openvino::frontend::gguf SHARED IMPORTED)

set_target_properties(openvino::frontend::gguf PROPERTIES
  INTERFACE_COMPILE_DEFINITIONS "OV_THREAD=OV_THREAD_TBB_ADAPTIVE"
  INTERFACE_LINK_LIBRARIES "openvino::runtime"
)
